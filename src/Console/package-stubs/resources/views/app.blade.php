...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script>
        window.Config = @json(new {{ namespace }}\Support\AppConfig)
    </script>
...
<body>
    <div id="app">
        <div class="flex items-center justify-center h-screen bg-gray-100">
            <div class="w-20 h-20 -mt-16">
                <svg class="text-gray-800" fill="none" viewBox="0 0 34 32" xmlns="http://www.w3.org/2000/svg">
