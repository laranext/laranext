<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 8 14" class="ml-2 text-gray-400 flex-shrink-0">
        <path class="fill-current"
              :class="{ 'text-gray-600': index.params.orderByDirection == 'asc' && index.params.orderBy == attribute }"
        ...
        <path class="fill-current"
              :class="{ 'text-gray-600': index.params.orderByDirection == 'desc' && index.params.orderBy == attribute }"
